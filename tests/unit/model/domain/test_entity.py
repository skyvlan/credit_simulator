...
class UnitTest(unittest.TestCase):
    ...
    def test_input_vehicle(self):
        vehicle = Vehicle(
            vehicle_type="mobil", vehicle_condition="baru", vehicle_year=2021
        )
    ...
    def test_loan_output(self):
        loan_output = LoanOutput(
            year=2021, installment=29166666.666666668, interest=0.05
        )
